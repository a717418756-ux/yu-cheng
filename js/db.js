...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.20.4';    // 章尾白按的真正原因(使用者診斷數值:捲1146→1528→1146｜寬1528｜頁寬382｜3/4):裝置捲動位置有1像素誤差(1145/1146)，epub.js 頁碼用「位置÷頁寬、無條件捨去」，1145÷382=2.997 少算一頁，明明在最後一頁卻說3/4，程式以為還有一頁去捲而白按。改用自己算的頁碼(四捨五入)並捲到該頁絕對位置；模擬±1像素誤差下，舊版每章尾多按1次，新版0次
