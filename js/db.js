...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.9.1';     // 修題庫考試別層題數不正確:openExamGroup 的 scoped 只篩年度+科目，完全沒套用類型篩選(選擇題/申論題/錯題/收藏)，導致選「申論題」時考試別仍把選擇題算進去—例如115刑法選申論題，警佐班/警大二技/其他各顯示40題(實際都是選擇題，應為0)，連上方總題數也一併算錯。補上與 openYearGroup、openQGroup 相同的四種篩選條件，三層現已完全一致。已用實際截圖情境驗證：申論題篩選下只剩三等考試4題、選擇題篩選下升官等歸0
