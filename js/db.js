...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.19.0';    // ①申論標號只到（1）：A、那層與三字標號縮小規則一併移除 ②標號與內文間距加大到半個字，題號和敘述更好分辨 ③電子書：epub.js 原本用「視窗高-120」估算版面高，實測比容器真正高度少 58px，每頁白白空一段；改量容器實際尺寸，頁碼列改固定高避免開書後高度變動 ④電子書翻頁加防連點(250ms)，點擊與滑動共用，避免一次操作翻兩頁
