...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.9.0';     // ①題庫上方篩選標籤移除題數，只顯示名稱(0題停用的邏輯保留) ②考試別層無題目時由「尚未新增」改為直接顯示「0 題」，與其他層一致 ③題庫管理專業化:三層分組卡片(年度／科目／考試別)加入掌握度視覺化—以錯題佔比呈現進度條與百分比，綠(<15%)穩、黃(15-40%)待加強、紅(≥40%)弱項，一眼看出哪個年度或科目最需要補強；未作答過的題組顯示「尚未作答」而非0%，避免把「還沒做」誤判成「很穩」。含 e-ink 版(無彩色，改用填滿比例與底線粗細區分)
