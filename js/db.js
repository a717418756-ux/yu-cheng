...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.17.1';    // 今日修改複查:①自備官網代碼(來源/備註欄貼網址)存入時只 trim，查詢時卻用 NFKC+去空白正規化，名稱含空白或全形字元時對不到，改為兩端同一套正規化 ②移除 utils.js 中已無用途的 S.aiJson 欄位。其餘(38部法規代碼全數對照官網查證、危險等級6情境、分析頁巢狀結構、匯出/診斷模擬)皆通過
