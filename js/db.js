...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.16.1';    // 資料庫搜尋範圍改用下拉選單(取代前一版的前綴語法):搜尋框左側加「全部／法規名稱／條文標題／條文內容／關鍵概念」下拉，一點就選，不必記語法也不用切輸入法。前一版的 parseFieldSearch/_FIELD_PREFIX/showLawSearchHelp 與 ⓘ 按鈕全部移除，不留兩套機制與死碼。§條號精準搜尋的判斷仍在範圍篩選之前，命中即 return，行為不受影響
