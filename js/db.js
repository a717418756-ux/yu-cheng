...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '3.6.1';     // 備考前最終體檢:修milestone.js的✕escape亂碼;清plan-title孤兒CSS;確認全JS語法/CSS無破損/onclick無not defined/無重複函式/版本一致/DB schema完整/備份功能正常/題庫分頁+搜尋索引(大量資料不卡)/自動清理機制齊全(資料不會無限累積),架構穩定可安心備考
