...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.0.3';     // 修 quiz.css 被截斷:前一版打包時 quiz.css 基底檔取用錯誤(僅含新增樣式的27行空殼)，導致原檔371行樣式全失—顯示模式按鈕跑版、答題畫面樣式盡失。已從完整原檔重建並接回新增樣式(398行)。同時全檔行數比對確認其餘檔案基底正確，base.css經選擇器計數比對確認僅移除TTS重複區塊無誤刪
