...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.1.1';     // ①修手寫標註位移根因:畫布高度原取scrollHeight，公布解答後版面變高→畫布重設尺寸→舊筆跡被拉伸重繪而位移；改為固定內部解析度800x1200與版面高度脫鉤，座標用getBoundingClientRect等比換算，版面怎麼變都不位移 ②手寫/備註按鈕改為作答後才出現(作答前不干擾判斷)，換題自動收起並退出標註模式 ③熱力圖美化:原35欄×32px總寬1120px超出螢幕被迫左右滑且格子鬆散，改7欄×5列一畫面完整呈現(手機格子約39-47px)，加漸層底、內陰影層次、按壓縮放回饋，eink版用邊框取代顏色深淺
