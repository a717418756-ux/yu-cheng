...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.15.4';    // 修法條關聯不符法制邏輯(子法每一條都掛母法):①根因—母法§12手動填的關聯是「整部子法」(無條號)，反推時 rNum=0 被當成「指向整部法規」，導致子法13條全部命中。依法制邏輯，母法只有一條授權「由某機關定之」、子法也只在第1條載明授權依據，故整部法規的引用只掛在該法第1條，其餘條文不顯示 ②第1條原本也抓不到「第12條」—內文是「本辦法依警察職權行使法（以下簡稱本法）第十二條」，法規名與條號之間夾了括號註解，endsWith 比對必然失敗；改為先剝除結尾的括號註解再比對(可處理連續多層括號) ③去除重複標籤:正向已有「○○法第X條」時，反推就不再重複列出同一部法規的名稱。實測:警職法§12→辦法、辦法§1→警職法第十二條、辦法§2/§3/§13 無關聯，符合法制邏輯
