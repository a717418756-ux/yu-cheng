...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.8.0';     // 申論參考答案改為國考手寫答案卷樣式:原本是深色底+每段編號的清單感，改為米白紙張(#f7f4ea)、深色卷頭抬頭、淡藍橫格線(用漸層繪製且與line-height對齊)、標楷體手寫字型、藍黑墨水色，並依申論慣用標號自動辨識架構層次做縮排—「一、」大標頂格、「(一)」次標縮一層、「1.」細目縮兩層、內文縮兩層再首行縮排兩字元(全形半形括號皆支援)。卷頭顯示科目與題號。目的是讓參考答案的視覺接近考場上真正會寫出來的版面，靠視覺記憶幫助回想架構。含 e-ink 版(純白紙、黑墨、淺灰格線)。舊的 es-sheet/es-line 樣式已完全移除無死碼
