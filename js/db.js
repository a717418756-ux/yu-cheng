...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.17.2';    // 法規資訊與大量匯入修正:①單條編輯表單沒有機關/修正日期欄位，存檔卻從不存在的欄位讀值，每編輯一條就把該條的機關與日期清空(法規資訊只看第一條，編輯第一條後資訊就消失)；改為沿用同法規既有值，顯示與排序改取該法規第一個有值的條文(_lawInfo)，舊資料不需修復即可正確顯示 ②大量匯入丟掉「之N」:第7條之1 存成第7條造成重複，官網格式「第 7-1 條」更會併進上一條內文；改為支援之N/中文之N/7-1，排序鍵與 art2n 一致(主號×1000+子號) ③覆蓋重匯時沿用原法規的機關與修正日期 ④修正日期接受 113.5.9／113-05-09／2024/5/9 等寫法並轉為民國標準格式 ⑤移除指向不存在元素 l-org-list 的死碼
