...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.11.1';    // 兩日改動全面複查:9JS語法/2CSS括號/五個測驗入口串接/13個函式匯出/死碼零殘留，v4.9.1~v4.11.0 全部回歸通過。複查中補上一項防護—模擬考中途離開原本沒有任何確認，寫到第35題誤觸返回鍵整場作廢；現在改為先確認(顯示已作答題數)，用 _mockExitConfirmed 旗標避免確認框遞迴，一般練習與零作答的模擬考不攔截
