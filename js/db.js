...
// 版本常數
// ════════════════════════════════════════════════════════════════
const APP_VERSION  = '4.7.3';     // 備份/還原完成提示改為需手動關閉:原本用 toast 幾秒就消失，沒注意到就不確定是否成功。改為彈窗顯示完成時間與涵蓋內容，必須按「知道了」才關閉；還原完成的頁面重新整理也改為按下後才執行(原本1.2秒自動重整，提示一閃而過)。四處皆套用(雲端備份/還原、本機備份/還原)，沿用既有說明彈窗的 .ov+.sh 樣式確保外觀一致
